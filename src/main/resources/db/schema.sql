...
CREATE TABLE STP_GET_UPDATE (
    ...
    MSG_SUB_FORMAT      VARCHAR2(10),
    FORMAT              VARCHAR2(10),
    MSG_SESSION         VARCHAR2(10),
    MSG_SEQUENCE        VARCHAR2(20),
    MSG_PRIORITY        VARCHAR2(5),
    MSG_USER_PRIORITY   VARCHAR2(10),
    MSG_USER_REFERENCE  VARCHAR2(100),
    MSG_NET_MIR         VARCHAR2(100),
    MSG_NET_INPUT_TIME  VARCHAR2(10),
    MSG_NET_OUTPUT_DATE VARCHAR2(20),
    MSG_PAC_RESULT      VARCHAR2(50),
    MSG_FIN_VALIDATION  VARCHAR2(50),
    MSG_PDE             VARCHAR2(5),
    MSG_PDM             VARCHAR2(5),
    MSG_COPY_SRV_ID     VARCHAR2(50),
    MSG_COPY_SRV_INFO   VARCHAR2(200),
    MSG_DEL_NOTIF_RQ    VARCHAR2(5),
    BLOCK4              CLOB,
    CREATED_AT          TIMESTAMP       NOT NULL
);
